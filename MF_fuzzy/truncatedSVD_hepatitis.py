...
cntr, u, _, _, _, _, _ = fuzz.cluster.cmeans(test_svd.T, cluster, 2, error=0.005, maxiter=1000, init=None)
defuzz = []
print(u)
...
new_X_train, new_X_test, new_Y_train, new_Y_test = train_test_split(test_svd, label, test_size=0.20)
...
pca_tra = pca.fit_transform(test_svd)
